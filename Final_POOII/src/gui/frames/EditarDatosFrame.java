 ...
 * @author henry
 */
public class EditarDatosFrame extends javax.swing.JFrame {

    /**
     * Creates new form EditarDatosFrame
     */
    Cliente cliente = new Cliente();
    
    public EditarDatosFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelMain, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarDatosFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarDatosFrame().setVisible(true);
            }
        });
    }
