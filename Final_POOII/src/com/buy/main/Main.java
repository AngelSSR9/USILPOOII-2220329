...
public class Main extends javax.swing.JFrame {
    ...
    private void testData() {
        ...
        int ID = 1;
        for (int i = 0; i <= 5; i++) {
            home.addItem(new ModelItem(ID++, "MONITOR", "This product is excluded from all promotional discounts and offers.", 160, "Monitor", new ImageIcon(getClass().getResource("/com/raven/image/monitor.jpeg"))));
            home.addItem(new ModelItem(ID++, "PROCESADOR", "This product is excluded from all promotional discounts and offers.", 100, "Procesaor", new ImageIcon(getClass().getResource("/com/raven/image/procesador.jpeg"))));
            home.addItem(new ModelItem(ID++, "RAM", "NMD City Stock 2", 150, "RAm", new ImageIcon(getClass().getResource("/com/raven/image/ram.jpeg"))));
            home.addItem(new ModelItem(ID++, "SSD", "NMD City Stock 2", 160, "SSD", new ImageIcon(getClass().getResource("/com/raven/image/ssd.jpeg"))));
            home.addItem(new ModelItem(ID++, "TARJETA", "NMD City Stock 2", 120, "Tarejeta", new ImageIcon(getClass().getResource("/com/raven/image/tarjeta.jpeg"))));
            home.addItem(new ModelItem(ID++, "VENTILADOR", "Ventilador", 160, "Adidas", new ImageIcon(getClass().getResource("/com/raven/image/ventilador.jpg"))));
        }
    }
