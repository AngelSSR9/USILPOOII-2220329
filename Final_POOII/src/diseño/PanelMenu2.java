...
public class PanelMenu2 extends javax.swing.JComponent {

    private final Animator animator;
    private final MenuCustom gradientMenu;
    private ButtonItem mainMenu;
    private boolean menuShow;
    private float animate;

    public PanelMenu2(MenuCustom gradientMenu, MigLayout layout, Font font, int index, String... menus) {
        initComponents();
        ...
        if (menus.length > 1) {
            ...
            mainMenu.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent ae) {
                    gradientMenu.hideShowMenu(PanelMenu2.this);
                    stopAnimation();
                    animator.start();
                }
            });
        ...
        animator = new Animator(200, new TimingTargetAdapter() {
            ...
            public void timingEvent(float fraction) {
                ...
                layout.setComponentConstraints(PanelMenu2.this, "h " + size + "!");
                revalidate();
                repaint();
            }
